...
const AVATAR_ID      = '513fd1b7-7ef9-466d-9af2-344e51eeb833'; // Anna
...
const ARIA_GREETING = 'Bonjour, je suis Anna. Je suis ici pour vous écouter en toute confidentialité. Comment vous sentez-vous aujourd\'hui ?';
